    ...
    <div class="hero-container">
      <div class="wow fadeIn">
        ...
        <div class="actions">
          ...
          <div id="nextDiv" style="display:none; border: 0;"><a href="#" class="btn-services" onclick="redirectResult()">Next</a></div>
...
function showPosition(position) {
    ...
    +latlon+"&zoom=14&size=400x300&key=AIzaSyAcNgQm3Pgi3TXeWB7Fh9YlcFC3ljzBTTs";
    document.getElementById("mapholder").innerHTML = "<img src='"+img_url+"'><br/>Is this your area? If yes, continue";
...
function redirectResult() {
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(giveCord, showError);
    } else {
        x.innerHTML = "Geolocation is not supported by this browser.";
    }
}
